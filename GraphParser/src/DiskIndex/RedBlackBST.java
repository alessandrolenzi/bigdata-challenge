...
public class RedBlackBST<Key extends Comparable<Key>, Value> {
    ...
    protected class Node<K, V> {
        protected K key;           // key
        protected K maxKey;		   // maximum!
        protected V val;         // associated data
        protected Node<K, V> left, right;  // links to left and right subtrees
        ...
        public void printNode(int indent) {
        	String tabber = "";
        	for (int i = 0; i < indent; i++) tabber += "\t";
        	System.out.println(tabber+"<"+key+","+val+">");
        	if (left != null) { System.out.println("L:"); left.printNode(indent+1);}
        	if (right != null) { System.out.println("R:"); right.printNode(indent+1);}
        }
    }
    
    public void printNode(int indent) {
    	root.printNode(indent);
    }
    ...
    *************************************************************************/
    ...
    private boolean isRed(Node<? extends Key, ? extends Value> x) {
        if (x == null) return false;
        return (x.color == RED);
    }

    // number of node in subtree rooted at x; 0 if x is null
    private int size(Node<? extends Key, ? extends Value> x) {
        if (x == null) return 0;
        return x.N;
    } 
    ...
    *************************************************************************/
    ...
    private Value get(Node<? extends Key, ? extends Value> x, Key key) {
        while (x != null) {
    ...
    private boolean contains(Node<? extends Key, ? extends Value> x, Key key) {
